...
| `ADR-001` | Authenticated encoding v1 | `0.4.1` | `DRAFT` | `docs/decisions/ADR-001-authenticated-encoding-v1.md` |
| `ADR-002` | Key scope and provisioning | `0.3.0` | `APPROVED` | `docs/decisions/ADR-002-key-scope-and-provisioning.md` |
| `ADR-003` | Append measurement boundary | `0.2.0` | `DRAFT` | `docs/decisions/ADR-003-append-measurement-boundary.md` |
| `ADR-004` | External Anchor and Checkpoint Externalization Boundary | `0.2.2` | `APPROVED` | `docs/decisions/ADR-004-external-anchor-boundary.md` |
